...
//definicion de pins
const int motorPin1 = 22;    // 28BYJ48 In1
const int motorPin2 = 24;    // 28BYJ48 In2
const int motorPin3 = 26;   // 28BYJ48 In3
const int motorPin4 = 28;   // 28BYJ48 In4
...
const int abortar = 32;     //El pin que se va usar para poner el boton de abortar
